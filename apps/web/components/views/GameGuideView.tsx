            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 text-xs text-stone-800">
                <p>
                  ...
                  Инженеры ведут исследования поквартально с бюджетом <strong>$2 000 / квартал</strong>.
                </p>
              ...
              <div className="space-y-3 text-xs text-stone-800">
                <div className="rounded-lg bg-amber-50/80 border border-amber-200 p-3 font-mono text-[11px] space-y-1">
                  ...
                  <div className="text-stone-800 font-bold">
                    Прибыль = Выручка от продаж − Себестоимость проданных авто − Накладные цеха − Кредитные проценты − Бюджет НИОКР
                  </div>
                </div>
                ...
                <div className="space-y-2 text-[11px] text-stone-700">
                  <p>
                    ...
                    Если завод выпустил 3 машины, но дилеры продали только 1, то выручка поступит только за 1 машину. 
                    Остальные 2 машины <strong>не пропали</strong> — они стоят на складе готовой продукции и будут проданы в следующем квартале! 
                    Однако постоянные расходы цеха ($600/кв.) и лаборатории ($2 000/кв.) списываются сразу.
                  </p>

                  <p>
                    <strong>Банковский овердрафт при дефиците:</strong><br />
                    Вам больше не нужно бояться случайного минуса! Если касса уходит в минус из-за закупки материалов, 
                    банк автоматически откроет <em>Кредитную линию овердрафта</em> с посильными ежемесячными взносами, 
                    позволяя продолжить работу предприятия.
                  </p>
                </div>
              </div>
            </div>
