...
export const de: TranslationSchema = {
  ...
  production: {
    ...
    distributeByDemand: 'Nach Nachfrage',
    distributeByDemandHint: 'Werksquoten proportional zur Marktnachfrage der Modelle verteilen',
    planDistributedByDemand: 'Modellquoten erfolgreich nach Marktnachfrage verteilt!',
