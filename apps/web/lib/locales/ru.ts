export const ru = {
  ...
  materials: {
    steel: 'Сталь и чугун',
    steelModern: 'Кузовная сталь и прокат',
    wood: 'Конструкционная древесина',
    woodModern: 'Древесина и шпон отделки',
    rubber: 'Натуральный каучук',
    rubberModern: 'Синтетический каучук и резина',
    leather: 'Кожа и отделка',
    aluminum: 'Алюминий',
    plastic: 'Пластик и полимеры',
    descriptions: {
      steelEarly: 'Основной металл для блоков цилиндров, тяжелых рам, рессор и мостов.',
      steelModern: 'Листовой автопрокат для штампованных цельнометаллических кузовов и агрегатов.',
      woodEarly: 'Критически важный материал эпохи 1900–1920: каретные каркасы, спицы колес, щитки.',
      woodModern: 'Декоративный шпон и элементы отделки интерьера престижных салонов.',
      rubberEarly: 'Колониальный каучук для ранних сплошных и пневматических шин, сальников и ремней.',
      rubberModern: 'Бутадиен-стирольный синтетический каучук (Buna/GR-S) и вулканизированная шинная резина.',
      leather: 'Материал отделки открытых диванов экипажа и складных брезентово-кожаных крыш.',
      aluminum: 'Легкий и прочный металл. Снижает вес авто и повышает скоростные качества.',
      plastic: 'Инновация 1950-х годов: удешевляет интерьер, заменяет дерево и тяжелые панели.',
    },
    units: {
      steel: 'кг',
      wood: 'ед.',
  ...
  production: {
    ...
    distributeByDemand: 'По спросу',
    distributeByDemandHint: 'Распределить квоты цеха пропорционально рыночному спросу на каждую модель',
    planDistributedByDemand: 'Квоты моделей успешно распределены в соответствии со спросом!',
  ...
  technologies: {
    ...
    'synthetic-rubber': {
      name: 'Синтетический каучук и эластомеры',
      description: 'Промышленный синтез бутадиен-стирольного каучука (Buna-S/GR-S). Ликвидирует зависимость от колониального импорта и снижает себестоимость шин.',
    },
