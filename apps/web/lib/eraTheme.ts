...
export const ERA_THEMES: Record<EraId, EraThemeConfig> = {
  ...
  'era-1920': {
    ...
    yearStart: 1920,
    yearEnd: 1939,
    bgClass: 'bg-[#f8f5ee] text-stone-900',
    cardClass: 'bg-[#fbf8f2] border-amber-600/30 shadow-sm',
    borderClass: 'border-amber-600/40',
    accentClass: 'bg-amber-600 text-white hover:bg-amber-500 font-bold',
    accentTextClass: 'text-amber-900',
    badgeBg: 'bg-amber-100 border border-amber-500/30',
    badgeText: 'text-amber-950',
    headerStyle: 'font-serif tracking-normal font-bold',
    advisorTitles: {
